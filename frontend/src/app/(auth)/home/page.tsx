...
export default function Page() {
    ...
    const publicar = async(data:PublicarMaterialDTO) =>{
        try {
            const response = await axios.post('http://localhost:3333/material/1',data)
    ...
    return (
        ...
        <div>
            ...
            <button className="bg-amber-600 w-20" onClick={() => publicar(publi)}>
                teste
            </button>
        </div>
