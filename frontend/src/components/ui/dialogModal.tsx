  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Trigger asChild>
        <button className="h-10 rounded-md border border-green-400 dark:border-violet-700 px-4 text-sm md:text-base text-neutral-700 dark:text-neutral-100 hover:bg-green-300 hover:cursor-pointer dark:hover:bg-violet-700 transition">
          Nova atividade
        </button>
      </Dialog.Trigger>
